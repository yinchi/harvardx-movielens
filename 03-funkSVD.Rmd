...
We use the model $Y <- P + \sim UV^\mathrm{T} + \varepsilon$
...
The matrix $k$ is known as the **rank** of matrix $UV$; i.e. $UV$ is a
...
```{r Funk-MF, fig.height=4, fig.width=4}
...
set.seed(1)
# nFeatures <- c(1, 2, 4, 8, 12, seq(14,24), 28, 32)
...
+ UV^\mathrm{T} + \varepsilon_{u,i}, (\#final-model)
\end{equation}
